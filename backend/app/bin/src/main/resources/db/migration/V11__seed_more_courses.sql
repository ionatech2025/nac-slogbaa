...
-- ---------------------------------------------------------------------------
-- Content blocks for modules above (TEXT only for brevity; rich_text in Editor.js JSON format)
-- ---------------------------------------------------------------------------

INSERT INTO content_block (id, module_id, block_type, block_order, rich_text, created_at, updated_at) VALUES
('55555555-5555-5555-5555-555555555504', '44444444-4444-4444-4444-444444444404', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Local government budgets affect services like health, education, and roads. This module explains how budgets are made and where you can find information."}}],"version":"2.8.1"}', current_timestamp, current_timestamp),
('55555555-5555-5555-5555-555555555505', '44444444-4444-4444-4444-444444444405', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Advocacy means making your voice heard so that decisions reflect community needs. Learn practical steps to engage with leaders and processes."}}],"version":"2.8.1"}', current_timestamp, current_timestamp),
('55555555-5555-5555-5555-555555555506', '44444444-4444-4444-4444-444444444406', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Young people have a right to participate in governance. This module covers formal and informal ways to get involved."}}],"version":"2.8.1"}', current_timestamp, current_timestamp),
('55555555-5555-5555-5555-555555555507', '44444444-4444-4444-4444-444444444407', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Good campaigns start with clear goals and a realistic strategy. We will look at planning tools you can use."}}],"version":"2.8.1"}', current_timestamp, current_timestamp),
('55555555-5555-5555-5555-555555555508', '44444444-4444-4444-4444-44444444440a', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Many people feel nervous about speaking in public. This module helps you understand that fear and build confidence through practice."}}],"version":"2.8.1"}', current_timestamp, current_timestamp),
('55555555-5555-5555-5555-555555555509', '44444444-4444-4444-4444-44444444440c', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Monitoring tracks what you do; evaluation asks whether it worked. Both help you learn and improve."}}],"version":"2.8.1"}', current_timestamp, current_timestamp),
('55555555-5555-5555-5555-55555555550a', '44444444-4444-4444-4444-44444444440d', 'TEXT', 1, '{"time":1730000000000,"blocks":[{"type":"paragraph","data":{"text":"Partnerships can bring more resources, skills, and legitimacy to your work. This module explores why they matter."}}],"version":"2.8.1"}', current_timestamp, current_timestamp);
