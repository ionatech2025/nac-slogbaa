...
const styles = {
  ...
  statCardHighlight: {
    ...
    background: 'var(--orange-surface, rgba(245, 130, 32, 0.05))',
    boxShadow: '0 1px 3px rgba(245, 130, 32, 0.06)',
  },
  statValue: {
    margin: 0,
    fontSize: '2.25rem',
  ...
  trStriped: { background: 'var(--orange-surface, rgba(245, 130, 32, 0.03))' },
  trLast: { borderBottom: 'none' },
  trSelected: { background: 'var(--orange-surface-hover, rgba(245, 130, 32, 0.06))' },
  empty: {
    padding: '2rem 1.5rem',
    textAlign: 'center',
    color: 'var(--slogbaa-text-muted)',
  ...
  viewProfileBtn: {
    ...
    cursor: 'pointer',
    marginRight: '0.35rem',
    background: 'var(--orange-surface-hover, rgba(245, 130, 32, 0.08))',
    color: 'var(--primary-orange, #F58220)',
  },
  deleteBtn: {
    display: 'inline-flex',
