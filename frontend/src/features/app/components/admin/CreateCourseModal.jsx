...
export function CreateCourseModal({ token, onClose, onSubmit }) {
    ...
    <Modal title="Create course" onClose={onClose}>
      <form style={styles.form} onSubmit={handleSubmit}>
        <div style={styles.field}>
          <label style={styles.label} htmlFor="course-title">Title</label>
          <input
            id="course-title"
            type="text"
            value={title}
        ...
        <div style={styles.field}>
          ...
          {imageUrl && (
            <div style={{ marginTop: '0.5rem' }}>
              {/* Preview: getAssetUrl normalizes src. codeql[js/xss] */}
              <img
        ...
        <div style={styles.field}>
          <label style={styles.label} htmlFor="course-desc">Description (optional)</label>
          <textarea
            id="course-desc"
            value={description}
